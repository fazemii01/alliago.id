...
<head>
    ...
    <title>User Login | Alliago.id</title>
    ...
    <div class="mx-auto flex min-h-screen max-w-6xl items-center justify-center px-4 sm:px-6 py-12">
        <div class="w-full max-w-md rounded-3xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm">
            <div class="mb-8">
                ...
                <h1 class="mt-4 text-3xl font-extrabold tracking-tight text-slate-900">User login</h1>
                <p class="mt-2 text-sm text-slate-600">Access your orders, profile details, and document communication with admin.</p>
            </div>
            ...
            <p class="mt-6 text-sm text-slate-600 text-center">
                Need an account?
                <a href="{{ route('client.register') }}" class="font-bold text-[#0361fc] hover:text-blue-700">Create one</a>
            </p>
        </div>
    </div>
</body>
